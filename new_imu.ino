...
void setup() {
  ...
  pinMode(13, OUTPUT);   
  Serial.begin(9600);                                                  //Set output 13 (LED) as output
...
void loop(){
  ...
  angle_pitch_acc -= 0.35;                                              //Accelerometer calibration value for pitch
  angle_roll_acc -= 1.95;                                               //Accelerometer calibration value for roll
